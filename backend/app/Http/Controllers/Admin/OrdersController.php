...
class OrdersController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        try {
            $validated = $request->validate([
                'status' => 'sometimes|required|string|in:Processing,Shipped,out_for_delivery,Delivered,Cancelled',
    ...
    public function updateStatus(Request $request, $id)
    {
        try {
            $validated = $request->validate([
                'status' => 'required|string|in:Processing,Shipped,out_for_delivery,Delivered,Cancelled',
            ]);
