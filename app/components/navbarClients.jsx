...
//             <Link href="/clients/" className="rounded-full bg-blue-50 text-black text-sm px-2.5 sm:px-3 py-2 sm:py-2.5 hover:bg-red-700 hover:text-white transition">
...
const NavbarClients = () => {
  ...
  const handleLogout = () => {
    ...
    router.replace('/pages/acountCreation')
  }

  return (
    <>
      <header
        className={`fixed inset-x-0 mt-4 top-0 left-0 w-full z-50 transition-transform duration-300 ${
          showNavbar ? 'translate-y-0' : '-translate-y-full'
        }`}
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 bg-white/10 backdrop-blur-md border rounded-full border-white/15 py-4 sm:py-5 flex items-center justify-between">
          ...
          >
            <div className="flex bg-white/10 backdrop-blur-md border rounded-full border-white/15 px-3 sm:px-4 py-2 justify-center items-center gap-3 sm:gap-4">
              <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full border border-cream/60 flex items-center justify-center font-display text-base sm:text-lg">
                C
              </div>
          ...
          <div className="flex items-center gap-3 sm:gap-5">
            ...
            <button
              ...
              className="rounded-full bg-blue-50 text-black text-sm px-2.5 sm:px-3 py-2 sm:py-2.5 hover:bg-red-700 hover:text-white transition cursor-pointer"
              aria-label="Logout"
            >
              <LogOut className="w-4 h-4 sm:w-5 sm:h-5" />
            </button>
          ...
          <div className="md:hidden mx-4 mt-2 bg-white/10 backdrop-blur-xl border border-white/15 rounded-3xl shadow-lg overflow-hidden">
            <nav className="flex flex-col p-4 gap-1">
              <Link
                href="/clients/home"
                onClick={handleLinkClick}
                className="text-gray-800 hover:bg-white/10 rounded-xl px-4 py-3 transition font-medium"
              >
                Home
              </Link>
