...
// //     return orders.filter(order => order.user_id === user.id || order.client_id === user.id);
// //   }, [orders, user]);
...
// //                       </td>
// //                       <td className="py-4 px-6">
// //                         <p className="text-sm text-gray-700 max-w-xs truncate" title={order.product}>
// //                           {order.product}
// //                         </p>
// //                       </td>
...
// //                   <p className="text-sm text-gray-700 font-medium line-clamp-2">{order.product}</p>
...
//     // product: order.product || order.product_name || order.title || order.description || 'N/A',
//      product: order.items
