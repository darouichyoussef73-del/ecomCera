      ...
      <>
        ...
        <div className="min-h-screen bg-[#faf7f3] flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm text-center max-w-md">
            ...
            <h3 className="text-lg font-semibold text-[#3D3228] mb-2">Not Logged In</h3>
            <p className="text-sm text-[#8A7E72] mb-6">Please log in to book our services.</p>
            <Link 
              href="/pages/acountCreation" 
              className="inline-block rounded-full bg-[#3D3228] text-white font-bold text-xs sm:text-sm px-6 sm:px-8 py-2.5 sm:py-3 hover:bg-[#2a2520] transition"
            >
              Log In
            </Link>
          </div>
          ...
          <Reveal>
            <div className="glass-card-dark p-10 md:p-16 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  href="mailto:darouichyoussef73@gmail.com"
