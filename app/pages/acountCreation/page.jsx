...
const page = () => {
  ...
  const handleLoginSubmit = async (e) => {
    ...
    // Admin bypass
    if (loginForm.email === "admin@admin.ma" && loginForm.password === "12345") {
          ...
          <div className="lg:w-[40%] bg-[#F5F0EB] relative p-8 lg:p-10 flex flex-col justify-between overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-10 anim-soft-right delay-1">
                ...
                <span className="font-serif text-lg font-semibold text-[#3D352E] tracking-tight">BrewSpace</span>
              </div>
              ...
              <p className="text-[#9C8B7A] text-sm leading-relaxed max-w-[240px] anim-fade-blur delay-3">
                A quiet space for your thoughts, ideas, and daily rituals.
              </p>
            </div>
            ...
            <div className="relative min-h-[380px]">
              ...
              <div id="loginForm" className="form-panel-soft max-w-sm mx-auto">
                <div className="text-center mb-8">
                  ...
                  <p className="text-[#9C8B7A] text-sm anim-fade-blur delay-1">We've saved your seat.</p>
                </div>
                ...
                <div className="divider-soft my-7 text-[#9C8B7A] text-xs anim-soft-reveal delay-5">
                  <span className="px-2 shrink-0">or continue with</span>
                </div>

                <div className="grid grid-cols-3 gap-3 anim-soft-reveal delay-6">
                  <button className="social-soft">
                  ...
                  <button className="social-soft">
                    <svg className="w-5 h-5 text-[#3D352E]" fill="currentColor" viewBox="0 0 24 24">
